...
def run_test_count_cosines_from():
    ...
    # ------------------------------------------------------------------
    expected = 2
    answer = count_cosines_from(2, 7, 0.16)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(1, 19, 0.76)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 37
    answer = count_cosines_from(12, 88, 0.1)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 39
    answer = count_cosines_from(1, 100, 0.29)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 393
    answer = count_cosines_from(0, 999, 0.33)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 5.1774
    answer = sum_unit_fractions_from(1, 99)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 6.2793
    answer = sum_unit_fractions_from(1, 299)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
